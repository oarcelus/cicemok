...
CONST_RESULT_MSG = ...
def analyze(problem, Y, calc_second_order=..., num_resamples=..., conf_level=..., print_to_console=..., parallel=..., n_processors=..., keep_resamples=..., seed=...) -> ResultDict:
...
def first_order(A, AB, B) -> NDArray[Any] | Any:
    """
...
def total_order(A, AB, B) -> NDArray[Any] | Any:
    """
...
def second_order(A, ABj, ABk, BAj, B) -> NDArray[Any] | Any:
    """Second order estimator following Saltelli 2002"""
    ...

def create_Si_dict(D: int, num_resamples: int, keep_resamples: bool, calc_second_order: bool) -> ResultDict:
    """initialize empty dict to store sensitivity indices"""
    ...

def separate_output_values(Y, D, N, calc_second_order) -> tuple[Any, Any, NDArray[float64], NDArray[float64] | None]:
    ...

def sobol_parallel(Z, A, AB, BA, B, r, tasks) -> list[Any]:
    ...

def create_task_list(D, calc_second_order, n_processors) -> tuple[Any, int | Any]:
    """
...
def Si_list_to_dict(S_list, D: int, num_resamples: int, keep_resamples: bool, calc_second_order: bool) -> ResultDict:
    """Convert the parallel output into the regular dict format for
    printing/returning"""
    ...

def Si_to_pandas_dict(S_dict) -> tuple[dict[str, Any], dict[str, Any], tuple[list[tuple[Any, Any]] | tuple[Any] | None, dict[str, list[Any]] | None]]:
