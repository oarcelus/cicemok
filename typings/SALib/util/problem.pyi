...
class ProblemSpec(dict):
    ...
    @property
    def analysis(self) -> list[Any] | dict[Any, Any] | None:
        ...
    
    def sample(self, func, *args, **kwargs) -> Self:
    ...
    def set_samples(self, samples: np.ndarray) -> Self:
        """Set previous samples used."""
        ...
    
    def set_results(self, results: np.ndarray) -> Self:
        """Set previously available model results."""
        ...
    
    def evaluate(self, func, *args, **kwargs) -> Self:
    ...
    def evaluate_parallel(self, func, *args, nprocs=..., **kwargs) -> Self:
    ...
    def evaluate_distributed(self, func, *args, nprocs=..., servers=..., verbose=..., **kwargs) -> Self:
    ...
    def analyze(self, func, *args, **kwargs) -> Self:
    ...
    def analyze_parallel(self, func, *args, nprocs=..., **kwargs) -> Self:
    ...
    def to_df(self) -> DataFrame | list[Any]:
    ...
    def heatmap(self, metric: str = ..., index: str = ..., title: str = ..., ax=...) -> Any:
