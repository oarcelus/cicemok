...
def main():
    ...
    try:
        ...
        for nsamples in lnsamples:
            ...
            with open(f"ref_samples_r_n{nsamples}.pkl", "wb") as file:
                pickle.dump(samples_r, file)
            with open(f"ref_samples_q_n{nsamples}.pkl", "wb") as file:
                pickle.dump(samples_q, file)
            # Save evals for the current iteration
            with open(f"ref_evaluations_n{nsamples}.pkl", "wb") as file:
